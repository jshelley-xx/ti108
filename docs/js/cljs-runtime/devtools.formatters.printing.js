...
var len__4829__auto___62890 = arguments.length;
var i__4830__auto___62892 = (0);
while(true){
if((i__4830__auto___62892 < len__4829__auto___62890)){
args__4835__auto__.push((arguments[i__4830__auto___62892]));

var G__62893 = (i__4830__auto___62892 + (1));
i__4830__auto___62892 = G__62893;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq62794){
...
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__62795,G__62796,seq62794__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__62827_SHARP_){
return (!((cljs.core.meta(p1__62827_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62841__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e62842){var _e__61944__auto__ = e62842;
return false;
}})();
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
...
}catch (e62848){var _e__61944__auto__ = e62848;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__62861 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__62862 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__62862);

try{var map__62863 = opts;
var map__62863__$1 = cljs.core.__destructure_map(map__62863);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62863__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__62861);
}});
...
var temp__5751__auto___62912 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___62912)){
var managed_print_level_62913 = temp__5751__auto___62912;
var _STAR_print_level_STAR__orig_val__62879_62914 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__62880_62915 = managed_print_level_62913;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__62880_62915);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__62871_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__62871_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__62879_62914);
}} else {
job_fn();
}
