...
var o62188 = temp__5751__auto__;
var temp__5751__auto____$1 = (o62188["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o62189 = temp__5751__auto____$1;
return (o62189["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__61895__auto__ = f;
return (o__61895__auto__["toString"]).call(o__61895__auto__);
} else {
return "";
}
}catch (e62200){var _ = e62200;
return "";
}});
...
try{var o__61895__auto___62668 = t;
(o__61895__auto___62668["cljs$lang$ctorPrWriter"]).call(o__61895__auto___62668,t,writer);
}catch (e62208){var __62669 = e62208;
}
...
var char_code = (function (){var o__61895__auto__ = (new String(char$));
return (o__61895__auto__["charCodeAt"]).call(o__61895__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__61895__auto__ = String;
return (o__61895__auto__["fromCharCode"]).call(o__61895__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__62219 = num_code;
switch (G__62219) {
case (1):
return (185);
...
var o__61895__auto__ = String;
return (o__61895__auto__["fromCharCode"]).call(o__61895__auto__,superscript_code);
});
/**
...
}catch (e62258){var _e__61944__auto__ = e62258;
return false;
}})())){
...
var vec__62261 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62261,(0),null);
...
var len__4829__auto___62681 = arguments.length;
var i__4830__auto___62683 = (0);
while(true){
if((i__4830__auto___62683 < len__4829__auto___62681)){
args__4835__auto__.push((arguments[i__4830__auto___62683]));

var G__62684 = (i__4830__auto___62683 + (1));
i__4830__auto___62683 = G__62684;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__62305){
var vec__62306 = p__62305;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62306,(0),null);
...
var G__62691 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__62692 = cljs.core.butlast(remaining_tokens);
name_tokens = G__62691;
remaining_tokens = G__62692;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq62299){
var G__62300 = cljs.core.first(seq62299);
var seq62299__$1 = cljs.core.next(seq62299);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__62300,seq62299__$1);
}));
...
var vec__62327 = cljs.core.split_with((function (p1__62326_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__62326_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62327,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62327,(1),null);
...
var vec__62343 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62343,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62343,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__62712 = cljs.core.rest(remaining_tokens);
var G__62713 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__62712;
name_tokens = G__62713;
continue;
} else {
...
var vec__62360 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62360,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62360,(1),null);
var vec__62363 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62363,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62363,(1),null);
var vec__62366 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62366,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62366,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62366,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62366,(3),null);
...
var vec__62384 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62384,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62384,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62384,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62384,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62384,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62384,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__62396 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62396,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62396,(1),null);
var vec__62399 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62399,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62399,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__62405 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__62405) : devtools.munging.parse_fn_info_deep.call(null,G__62405));
})()));
}
} else {
return fn_info;
...
var G__62753 = (arity + (1));
var G__62754 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__62435){
var vec__62438 = p__62435;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62438,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62438,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__62466_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__62466_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__62467_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__62467_SHARP_);
}),sorted_infos);
...
var args__4835__auto__ = [];
var len__4829__auto___62764 = arguments.length;
var i__4830__auto___62765 = (0);
while(true){
if((i__4830__auto___62765 < len__4829__auto___62764)){
args__4835__auto__.push((arguments[i__4830__auto___62765]));

var G__62767 = (i__4830__auto___62765 + (1));
i__4830__auto___62765 = G__62767;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__62484){
var vec__62486 = p__62484;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62486,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq62475){
var G__62476 = cljs.core.first(seq62475);
var seq62475__$1 = cljs.core.next(seq62475);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__62476,seq62475__$1);
}));
...
var G__62497 = arg;
var G__62497__$1 = (((G__62497 instanceof cljs.core.Keyword))?G__62497.fqn:null);
switch (G__62497__$1) {
...
var map__62522 = options;
var map__62522__$1 = cljs.core.__destructure_map(map__62522);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62522__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62522__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62522__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62522__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__62523 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62523,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62523,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62523,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62523,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62523,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62523,(5),null);
...
var o__61895__auto__ = f;
return (o__61895__auto__["getBasis"]).call(o__61895__auto__);
});
/**
...
}catch (e62552){var _e__61944__auto__ = e62552;
...
var _STAR_ = (function (accum,p__62588){
var vec__62589 = p__62588;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62589,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62589,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__62614){
var vec__62617 = p__62614;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62617,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62617,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62617,(2),null);
...
var post_process = (function (p__62644){
var vec__62645 = p__62644;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62645,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62645,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__62635_SHARP_){
return (obj[cljs.core.first(p1__62635_SHARP_)]);
}),sorted_matches);
