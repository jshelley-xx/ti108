...
var G__62788 = devtools.prefs.pref(v);
v = G__62788;
continue;
} else {
return v;
...
}catch (e62695){var _e__61944__auto__ = e62695;
return false;
}})();
...
}catch (e62714){var _e__61944__auto__ = e62714;
return false;
}})();
...
}catch (e62741){var _e__61944__auto__ = e62741;
return false;
}}
}
});
...
var vec__62758 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62758,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62758,(1),null);
...
return cljs.core.some((function (p1__62766_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__62766_SHARP_);
}),template);
});
