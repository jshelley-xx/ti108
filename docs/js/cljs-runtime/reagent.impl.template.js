...
var G__71895 = o;
goog.object.set(G__71895,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__72126__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__72126 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__72127__i = 0, G__72127__a = new Array(arguments.length -  0);
while (G__72127__i < G__72127__a.length) {G__72127__a[G__72127__i] = arguments[G__72127__i + 0]; ++G__72127__i;}
  args = new cljs.core.IndexedSeq(G__72127__a,0,null);
} 
return G__72126__delegate.call(this,args);};
G__72126.cljs$lang$maxFixedArity = 0;
G__72126.cljs$lang$applyTo = (function (arglist__72128){
var args = cljs.core.seq(arglist__72128);
return G__72126__delegate(args);
});
G__72126.cljs$core$IFn$_invoke$arity$variadic = G__72126__delegate;
return G__72126;
})()
;
} else {
...
var G__71917 = o;
goog.object.set(G__71917,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__72131__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__72131 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__72132__i = 0, G__72132__a = new Array(arguments.length -  0);
while (G__72132__i < G__72132__a.length) {G__72132__a[G__72132__i] = arguments[G__72132__i + 0]; ++G__72132__i;}
  args = new cljs.core.IndexedSeq(G__72132__a,0,null);
} 
return G__72131__delegate.call(this,args);};
G__72131.cljs$lang$maxFixedArity = 0;
G__72131.cljs$lang$applyTo = (function (arglist__72133){
var args = cljs.core.seq(arglist__72133);
return G__72131__delegate(args);
});
G__72131.cljs$core$IFn$_invoke$arity$variadic = G__72131__delegate;
return G__72131;
})()
;
} else {
...
var G__71925 = props;
var G__71925__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__71925,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__71925);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__71925__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4223__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__71933 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__71933,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__71933;
}
})(),id_class);
...
var G__71938 = (cljs.core.count(argv) - first_child);
switch (G__71938) {
case (0):
...
var vec__71964 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71964,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71964,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71964,(2),null);
...
var temp__5757__auto___72151 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___72151 == null)){
} else {
var key_72152 = temp__5757__auto___72151;
(jsprops.key = key_72152);
}
...
var temp__5757__auto___72160 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___72160 == null)){
} else {
var key_72163 = temp__5757__auto___72160;
(jsprops.key = key_72163);
}
...
var temp__5757__auto___72174 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___72174 == null)){
} else {
var key_72175 = temp__5757__auto___72174;
(jsprops.key = key_72175);
}
...
var temp__5757__auto___72187 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___72187 == null)){
} else {
var key_72188 = temp__5757__auto___72187;
(jsprops.key = key_72188);
}
...
var temp__5757__auto___72193 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___72193 == null)){
} else {
var key_72194 = temp__5757__auto___72193;
(jsprops.key = key_72194);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__72063_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__72063_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__72067 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72067,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72067,(1),null);
...
break;
default:
var G__72219 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__72220 = compiler;
v = G__72219;
compiler = G__72220;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template72096 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template72096 = (function (opts,id,fn_to_element,parse_fn,meta72097){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta72097 = meta72097;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template72096.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_72098,meta72097__$1){
var self__ = this;
var _72098__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template72096(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta72097__$1));
}));

(reagent.impl.template.t_reagent$impl$template72096.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_72098){
var self__ = this;
var _72098__$1 = this;
return self__.meta72097;
}));

(reagent.impl.template.t_reagent$impl$template72096.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template72096.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template72096.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template72096.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template72096.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template72096.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta72097","meta72097",-1236450820,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template72096.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template72096.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template72096");

(reagent.impl.template.t_reagent$impl$template72096.cljs$lang$ctorPrWriter = (function (this__4461__auto__,writer__4462__auto__,opt__4463__auto__){
return cljs.core._write(writer__4462__auto__,"reagent.impl.template/t_reagent$impl$template72096");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template72096.
 */
reagent.impl.template.__GT_t_reagent$impl$template72096 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template72096(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta72097){
return (new reagent.impl.template.t_reagent$impl$template72096(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta72097));
});

}

return (new reagent.impl.template.t_reagent$impl$template72096(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
