(defproject ti108 "0.1.0-SNAPSHOT"
  ...
  :ring {:handler ti108.handler/app
         :uberwar-name "ti108.war"}

  :min-lein-version "2.5.0"
  :uberjar-name "ti108.jar"
  :main ti108.server
  ...
  {:builds {:min
            ...
            {:source-paths ["src/cljs" "src/cljc" "env/dev/cljs"]
             :figwheel {:on-jsload "ti108.core/mount-root"}
             :compiler
             {:main "ti108.dev"
              :asset-path "/js/out"
              :output-to "target/cljsbuild/public/js/app.js"
  ...
  :profiles {:dev {:repl-options {:init-ns ti108.repl}
